...
;	uses d0.l, d1.l, d2.w, d3.l, d4.l, d5.l, d6.l, d7.l, a0, a1, a2, a3, a4
; ---------------------------------------------------------------------------
...
;	uses d0.l, d1.l, d3.l, d4.l, d5.l, d6.l, d7.l, a0, a1, a2, a4
; ---------------------------------------------------------------------------
...
;	uses d0.l, d1.l, d3.l, d4.w, d6.l, d7.l, a0, a1
; ---------------------------------------------------------------------------
...
DrawBlock:
		...
		move.l	d0,(a6)					; send VDP command to vdp_control_port
		move.l	(a1)+,-4(a6)				; write top two tiles
		add.l	d7,d0					; next row
		move.l	d0,(a6)
		move.l	(a1)+,-4(a6)				; write bottom two tiles
		rts
...
DrawFlipX:
		...
		move.l	d4,-4(a6)				; write top two tiles
		add.l	d7,d0					; next row
		move.l	d0,(a6)
		move.l	(a1)+,d4
		eori.l	#$8000800,d4
		swap	d4
		move.l	d4,-4(a6)				; write bottom two tiles
		rts
...
DrawFlipY:
		...
		move.l	d4,-4(a6)				; write bottom two tiles on top
		add.l	d7,d0					; next row
		move.l	d0,(a6)
		eori.l	#$10001000,d5
		move.l	d5,-4(a6)				; write top two tiles on bottom
		rts
