...
GFire_Index:	index *,,2
		...
		rsobj GrassFire
ost_burn_x_start:	rs.w 1 ; $2A				; original x position (2 bytes)
ost_burn_y_start:	rs.w 1 ; $2C				; original y position (2 bytes)
ost_burn_coll_ptr:	rs.l 1 ; $30				; pointer to collision data (4 bytes)
ost_burn_parent:	rs.l 1 ; $38				; address of OST of parent object (4 bytes)
