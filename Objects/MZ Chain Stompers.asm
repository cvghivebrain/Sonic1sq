...
CStom_Length_6:	dc.w $B800					; 6 - unused
		...
		rsobj ChainStomp
ost_cstomp_y_start:		rs.w 1 ; $30			; original y position (2 bytes)
ost_cstomp_chain_length:	rs.w 1 ; $32			; current chain length (2 bytes)
ost_cstomp_chain_max:		rs.w 1 ; $34			; maximum chain length (2 bytes)
ost_cstomp_rise_flag:		rs.w 1 ; $36			; 0 = falling; 1 = rising (2 bytes)
ost_cstomp_delay_time:		rs.w 1 ; $38			; time delay between fully extended and rising again (2 bytes)
ost_cstomp_switch_id:		rs.b 1 ; $3A			; switch number for the current stomper
ost_cstomp_parent:		rs.l 1 ; $3C			; address of OST of parent object (4 bytes)
		rsobjend
; ===========================================================================
