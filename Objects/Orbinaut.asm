...
ost_orb_parent:		rs.l 1 ; $3C				; address of OST of parent object (4 bytes)
		rsobjend
; ===========================================================================
...
.orb_loop:
		...
		move.l	ost_id(a0),ost_id(a1)			; load spiked orb object
...
Orb_MoveOrb:	; Routine 6
		...
		cmpi.l	#Orbinaut,ost_id(a1)			; does parent object still exist?
