...
ost_spinc_x_pos_centre:	rs.w 1 ; $30				; approximate x position of centre of conveyor (2 bytes)
ost_spinc_corner_x_pos:	rs.w 1 ; $34				; x position of next corner (2 bytes)
ost_spinc_corner_y_pos:	rs.w 1 ; $36				; y position of next corner (2 bytes)
...
ost_spinc_corner_ptr:	rs.l 1 ; $3C				; address of corner position data (4 bytes)
		rsobjend
; ===========================================================================
