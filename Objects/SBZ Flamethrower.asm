...
Flame_Index:	index *,,2
		...
		rsobj Flamethrower
ost_flame_time:		rs.w 1 ; $30				; time until current action is complete (2 bytes)
ost_flame_on_master:	rs.w 1 ; $32				; time flame is on (2 bytes)
ost_flame_off_master:	rs.w 1 ; $34				; time flame is off (2 bytes)
