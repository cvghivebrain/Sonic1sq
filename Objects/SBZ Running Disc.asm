...
Disc_Index:	index *,,2
		...
		rsobj RunningDisc
ost_disc_y_start:	rs.w 1 ; $30				; original y-axis position (2 bytes)
ost_disc_x_start:	rs.w 1 ; $32				; original x-axis position (2 bytes)
ost_disc_inner_radius:	rs.b 1 ; $34				; distance of small circle from centre
ost_disc_rotation:	rs.w 1 ; $36				; rate/direction of small circle rotation (2 bytes)
