...
Pillar_Start:	; Routine 2
		...
		beq.s	Pillar_ChkDisplay			; if not, branch
...
Pillar_Move:	; Routine 4
		...
		bne.s	Pillar_ChkDisplay			; branch if object hasn't reached destination
...
Pillar_Finish:	; Routine 6
		bsr.w	SolidNew
		bra.s	Pillar_ChkDisplay
; ===========================================================================
		
Pillar_Final:
		cmpi.b	#2,(v_sbz3pillar_status).w
		bne.s	Pillar_Delete				; delete if original object hasn't reached final position
		bra.s	Pillar_ChkDisplay