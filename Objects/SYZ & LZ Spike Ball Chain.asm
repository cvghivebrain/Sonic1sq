...
ost_sball_child_list:	rs.b 8 ; $30				; OST indices of child objects and parent (8 bytes)
ost_sball_y_start:	rs.w 1 ; $38				; centre y-axis position (2 bytes)
ost_sball_x_start:	rs.w 1 ; $3A				; centre x-axis position (2 bytes)
ost_sball_radius:	rs.b 1 ; $3C				; radius (1 byte)
ost_sball_speed:	rs.w 1 ; $3E				; rate of spin (2 bytes)
		rsobjend
; ===========================================================================
