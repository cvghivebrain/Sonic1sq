...
v_debug_ost_setting:		rs.w 1				; which OST values are displayed (0 = x/y pos; 4 = x/y speed; 8 = angle/routine)
v_debug_hitbox_setting:		rs.b 1				; which hitboxes are displayed (0 = width/height; 1 = hitbox)
f_debug_overlay_hide:		rs.b 1				; flag set to hide overlay
...
v_syzdoor_status:		equ v_sbz3pillar_status
...
v_player1_hitbox_width:		rs.w 1				; player 1 half width, standing/running etc. (hitbox)
v_player1_hitbox_height:	rs.w 1				; player 1 half height, standing/running etc. (hitbox)
v_player1_hitbox_width_roll:	rs.w 1				; player 1 half width, rolling/jumping (hitbox)
v_player1_hitbox_height_roll:	rs.w 1				; player 1 half height, rolling/jumping (hitbox)
